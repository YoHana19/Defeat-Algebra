...
class InputVariableExpressionEasy: SKSpriteNode {
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if nodeAtPoint.name == "buttonX" {
            ...
            if operant == 0 {
                if coefficientFlag == false {
                    outputValue += gameSceneEasy.xValue
                    gameSceneEasy.activeCatapult.coefficientArray.append(1)
                } else {
                    outputValue += tempSpot*gameSceneEasy.xValue
                    gameSceneEasy.activeCatapult.coefficientArray.append(tempSpot)
        ...
        if nodeAtPoint.name == "button+" {
            ...
            if coefficientFlag {
                if operant == 0 {
                    ...
                    gameSceneEasy.activeCatapult.constantsArray.append(tempSpot)
                    operant = 0
                    coefficientFlag = false
                    tempSpot = 0
                } else {
        ...
        if nodeAtPoint.name == "buttonClear" {
            ...
            gameSceneEasy.activeCatapult.resetVEElementArray()
        ...
        if nodeAtPoint.name == "buttonFire" {
            ...
            if variableExpression.count > 6 {
                ...
                gameSceneEasy.activeCatapult.variableExpression = variableExpression
                if operant == 0 {
                    outputValue += tempSpot
                ...
                let onFlag = SKAction.run({ gameSceneEasy.catapultFireReady = true })
    ...
    func setButtons() {
        ...
        addChild(buttonFire)
        let coverFire = setCoverButtons(buttonSize: radius, buttonPosition: CGPoint(x: -200, y: -260))
