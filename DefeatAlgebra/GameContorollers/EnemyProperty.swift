...
class EnemyProperty {
    ...
    */
    ...
    static let simplifiedVariableExpressionSource: [[[Int]]] = [
        ...
        [[0 ,1, 0, 0], [0, 1, 1, 3], [0, 1, 2, 4], [1, 1, 1, 3], [2, 1, 1, 3], [3, 1, 1, 3], [4, 1, 1, 3]],
        [[0, 1, 0, 0], [0, 1, 1, 3], [0, 1, 2, 4], [0, 1, 3, 5], [1, 1, 1, 3], [1, 1, 2, 4], [1, 1, 3, 5]], //4
        [[0, 1, 0, 0], [0, 2, 0, 1], [0, 3, 0, 2]], //5
        [[0, 1, 0, 0], [0, 2, 0, 1], [0, 3, 0, 2], [0, 1, 1, 3], [0, 2, 1, 6], [0, 3, 1, 9], [0, 1, 2, 4], [0, 2, 2, 7], [0, 3, 2, 10], [1, 1, 1, 3], [1, 2, 1, 4], [1, 3, 1, 5], [1, 1, 2, 4], [1, 2, 2, 7], [1, 3, 2, 8]], //6
        [[0, 1, 1, 3], [0, 2, 1, 6], [0, 3, 1, 9], [0, 1, 2, 4], [0, 2, 2, 7], [0, 3, 2, 10], [4, 2, 1, 12], [4, 3, 1, 13], [4, 3, 2, 14], [5, 1, 4, 18], [5, 2, 7, 19], [5, 2, 8, 20]], //7
        [[0 ,1, 0, 0], [0, 1, 1, 3], [0, 2, 0, 1], [0, 2, 1, 6]] //8
    ]
    ...
    static let simplifiedVariableExpressionLabelSource: [[String]] = [
        ...
        ["x"], //2
        //["x", "x+1", "x+2"], //3
        ["x", "x+1", "x+2", "1+x", "2-1+x", "1+1×x", "x-1+2"],
    ...
    static let addEnemyManager = [
        ...
        [[0], [1, 1, 2], [0], [0], [0], [0], [0], [1, 1, 2], [0], [0], [1, 0, 3, 1]], //8
    ]
