            ...
            if tutorialState == .T5 {
                ...
                case .GameOver:
                    ...
                    if gameOverDoneFlag == false {
                        ...
                        if hitByEnemyFlag {
                            self.createTutorialLabel(text: "敵のこうげきがあたると、ゲームオーバーだ！", posY: 720)
                            buttonRetry.state = .msButtonNodeStateActive
                        } else {
                            self.createTutorialLabel(text: "町のライフが０になったら", posY: 750)
                            self.createTutorialLabel(text: "ゲームオーバーだ！", posY: 690)
                            buttonRetry.state = .msButtonNodeStateActive
                        }
                    }
                    break;
    ...
    func tutorialFlow() {
        ...
        case 0:
            ...
            case .T0:
                ...
                let showDisc = SKAction.run({ self.createTutorialLabel(text: "彼は町を守る勇者(ゆうしゃ)！", posY: 1100) })
            ...
            case .T2:
                resetDiscription()
                createTutorialLabel(text: "勇者（ゆうしゃ）をうごかそう！", posY: 1100)
                createTutorialLabel(text: "青いところをタッチ！", posY: 1040)
                /* Show move area */
                self.gridNode.showMoveArea(posX: activeHero.positionX, posY: activeHero.positionY, moveLevel: activeHero.moveLevel)
                break;
            case .T3:
                removeTutorial()
                createTutorialLabel(text: "いいぞ！", posY: 1100)
                createTutorialLabel(text: "次は、ブーツをとろう！", posY: 1040)
            ...
            case .T5:
                ...
                createTutorialLabel(text: "ブーツをとったから", posY: 1100)
                createTutorialLabel(text: "うごける範囲（はんい）が広がったぞ！", posY: 1040)
                /* Show move area */
                self.gridNode.showMoveArea(posX: activeHero.positionX, posY: activeHero.positionY, moveLevel: activeHero.moveLevel)
                showTouchScreen(waitTime: 2.0)
                break;
            case .T6:
                resetDiscription()
                createTutorialLabel(text: "青いところを指でなぞれば", posY: 1100)
                createTutorialLabel(text: "うごくみちすじをしていできるぞ！", posY: 1040)
            ...
            case .T7:
                removeTutorial()
                createTutorialLabel(text: "青いところの外までなぞれば", posY: 1100)
                createTutorialLabel(text: "うごかすのをやめれるぞ", posY: 1040)
            ...
            case .T8:
                removeTutorial()
                self.createTutorialLabel(text: "その場にいたままにしたいなら", posY: 1100)
                self.createTutorialLabel(text: "自分がいるマスをタッチしよう！", posY: 1040)
            ...
            case .T9:
                ...
                removeTutorial()
                self.createTutorialLabel(text: "これで", posY: 1100)
                self.createTutorialLabel(text: "勇者（ゆうしゃ）の動かし方はOKだ!!", posY: 1040)
                showTouchScreen(waitTime: 2.0)
                break;
            case .T10:
                resetDiscription()
        ...
        case 1:
            ...
            case .T0:
                ...
                let showDisc = SKAction.run({ self.createTutorialLabel(text: "こいつらは 'もじしきロボット'!!", posY: 1100) })
                let wait2 = SKAction.wait(forDuration: 0.5)
                let moveState = SKAction.run({
                    self.tutorialDone = false
                    self.tutorialState = .T1
            ...
            case .T2:
                resetDiscription()
                self.createTutorialLabel(text: "やつらは町を破壊（はかい）", posY: 1100)
                self.createTutorialLabel(text: "するために町へむかっている!", posY: 1040)
                gridNode.enemyArray[0].myTurnFlag = true
                tutorialState = .T3
                tutorialDone = false
                break;
            ...
            case .T5:
                ...
                self.createTutorialLabel(text: "これらの数字は", posY: 1100)
                self.createTutorialLabel(text: "いつ敵が攻撃してくるかを示している", posY: 1040)
                showTouchScreen(waitTime: 2.0)
                break;
            case .T6:
                resetDiscription()
                ...
                self.createTutorialLabel(text: "この数字が0の時", posY: 1100)
                self.createTutorialLabel(text: "敵がこうげきしてくるぞ！", posY: 1040)
                showTouchScreen(waitTime: 2.0)
                break;
            case .T7:
                resetDiscription()
                self.valueOfX.text = "3"
                self.createTutorialLabel(text: "'もじしきロボット' のこうげき方法は", posY: 1100)
                self.createTutorialLabel(text: "'もじしきパンチ'だ!", posY: 1040)
            ...
            case .T8:
                resetDiscription()
                self.createTutorialLabel(text: "このときは、'もじ「X」'が3だから", posY: 1100)
                self.createTutorialLabel(text: "この'もじしきロボット'は3マス分パンチ!", posY: 1040)
            ...
            case .T9:
                resetDiscription()
                self.gridNode.resetSquareArray(color: "red")
                self.createTutorialLabel(text: "そして、パンチした後", posY: 1100)
                self.createTutorialLabel(text: "そのまま前に進んでくるぞ!", posY: 1040)
            ...
            case .T11:
                resetDiscription()
                self.createTutorialLabel(text: "'もじ「X」'に入る数字は", posY: 1100)
                self.createTutorialLabel(text: "赤く光る回数で変わるんだ!", posY: 1040)
                let icon = self.setPointingIcon2(position: CGPoint(x: self.valueOfX.position.x-150, y: self.valueOfX.position.y-25), size: CGSize(width: 60, height: 52))
                self.addChild(icon)
            ...
            case .T12:
                ...
                break;
            case .T13:
                self.createTutorialLabel(text: "敵のこうげきが町にあたると", posY: 1100)
                self.createTutorialLabel(text: "まちのライフが減るぞ!", posY: 1040)
            ...
            case .T15:
                ...
                resetDiscription()
                self.createTutorialLabel(text: "町のライフが0になったら", posY: 1100)
                self.createTutorialLabel(text: "ゲームオーバーだ", posY: 1040)
                gameOverLabel.isHidden = false
                showTouchScreen(waitTime: 2.0)
                break;
            case .T16:
        ...
        case 2:
            ...
            case .T0:
                ...
                let showDisc = SKAction.run({
                    self.createTutorialLabel(text: "やつがやってきた！！", posY: 780)
                    self.createTutorialLabel(text: "敵をたおして、町を守れ！", posY: 720)
                })
                let wait2 = SKAction.wait(forDuration: 0.5)
                let moveState = SKAction.run({
                    self.tutorialDone = false
            ...
            case .T2:
                resetDiscription()
                self.createTutorialLabel(text: "自分のまわりの赤いところがこうげきはんいだ！", posY: 750)
                gridNode.showAttackArea(posX: activeHero.positionX, posY: activeHero.positionY, attackType: 0)
                showTouchScreen(waitTime: 2.0)
                break;
            case .T3:
                resetDiscription()
                self.createTutorialLabel(text: "だから、敵に攻撃したいときは", posY: 780)
                self.createTutorialLabel(text: "その敵のとなりにいくひつようがあるんだ!", posY: 720)
                showTouchScreen(waitTime: 2.0)
                break;
            case .T4:
                resetDiscription()
                gridNode.resetSquareArray(color: "red")
                self.createTutorialLabel(text: "敵のとなりまで行こう!!", posY: 750)
            ...
            case .T6:
                ...
                buttonAttack.isHidden = false
                buttonItem.isHidden = false
                self.createTutorialLabel(text: "これで、敵に攻撃できるぞ!", posY: 1100)
                self.createTutorialLabel(text: "こうげきボタンをタッチしよう!!", posY: 1040)
            ...
            case .T7:
                resetDiscription()
                createTutorialLabel(text: "赤いところをタッチすれば!", posY: 1100)
                createTutorialLabel(text: "敵を攻撃できるぞ!!", posY: 1040)
                setPointingIcon(position: CGPoint(x: self.gridNode.position.x+self.gridNode.enemyArray[0].position.x+55, y: self.gridNode.position.y+self.gridNode.enemyArray[0].position.y+80), size: CGSize(width: 60, height: 52))
                break;
            case .T8:
                /* Play Sound */
                ...
                resetDiscription()
                createTutorialLabel(text: "やったね!", posY: 1100)
                createTutorialLabel(text: "これで敵のたおし方をマスターしたぞ！", posY: 1000)
