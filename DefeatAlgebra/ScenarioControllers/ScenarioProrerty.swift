...
struct ScenarioProperty {
    ...
    static let scenarioInvisibleStartTurn: [[String]] = [
        ...
        ["0", "記録を見てみよう"],
        ["pause"],
        ["0", "飛距離にxを入力したから、敵の攻撃の長さとアルジェ砲の飛距離は常に一緒じゃな"],
        ["pause"],
        ["0", "そして、砲撃と敵との距離も常に2のようじゃのう"],
        ["2", "これは、何か関係がありそうですね"],
        ["0", "そうじゃな・・・。砲撃の飛距離を変えてみよう"],
        ["pause"],
        ["0", "このボタンをタッチするのじゃ"],
        ["0", "砲撃と敵との距離が常に2のようじゃから、x+2を入力してみよう"],
        ["0", "もう一度xに数を入れて、試し撃ちして見るのじゃ"],
        ["0", "おお！砲撃が当たったのう！他のxの数でも試してみるのじゃ！"],
        ["0", "またジャストミートじゃ！"],
        ["0", "これも当たりじゃ！"],
        ["0", "飛距離にx+2を入力すれば、必ず砲撃が当たることがわかったのう！！"],
        ["pause"],
        ["0", "やめるボタンをタッチして、試し撃ちを終了しよう"],
        ["0", "アルジェ砲が敵の持つ信号を受信するぞ！"],
        ["pause"],
        ["2", "やった！敵を倒せたぞ！"],
        ["0", "試し撃ちで、xに入る数がいくつでも砲撃が当たることを確認したからのう！"],
        ["0", "信号の中身がわからなくても、改良したアルジェ砲を上手く使えば敵を倒せるはずじゃ！"],
        ["2", "試し撃ちを使いながら、確実に倒せる方法を見つければいいんだね！"],
        ["0", "その通りじゃ！敵も残り少ないはずじゃ、任せたぞエックスよ！"],
        ["2", "合点承知！"],
        ["pause"]
    ]
